...
import { TAB_RULES } from '@/constant'
import { ref } from 'vue'
...
<template>
	<div class="w-full flex gap-4 mt-11">
		<div class="w-[380px] bg-[#1A1529] rounded-xl p-5 mb-36">
			<h4 class="text-[#BC74D4] text-xl font-bold">Разделы правил</h4>
